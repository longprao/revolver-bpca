<?php
function revolver_place_meta_box() {
	add_meta_box( 
		'revolver_place_metabox',
		__( 'Place Data', 'revolver_metabox' ),
		'revolver_place_metabox_func',
		'place',
		'normal',
		'high'
	);
}
add_action( 'add_meta_boxes', 'revolver_place_meta_box' );


function place_save_postdata() {
...
add_action( 'save_post', 'place_save_postdata' );

function revolver_place_metabox_func() {
